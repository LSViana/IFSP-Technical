...
public class Register {
	...
	public void show() throws ParseException, ClassNotFoundException, SQLException {
		...
		//
		Object[] components = new Object[] { "Unique Ident.:", enrollment, "Student Name:", studentName, "Age:", age };
		Object[] options = new Object[] { "Save", "Return" };
		//
		int choice = -1;
		do {
			...
			if (choice == 0) {
				if ((int) age.getValue() < 18) {
					JOptionPane.showMessageDialog(null, "You can't register or save a Student with less than 18 years.",
							"Registering Students", JOptionPane.ERROR_MESSAGE);
